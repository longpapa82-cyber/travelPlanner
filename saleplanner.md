...
| 0.2 | AdMob 콘솔 GDPR 메시지 설정 | 사용자 | ❌ 미시작 | EU 사용자 동의 폼 필수 |
| 0.3 | 프로덕션 APK/AAB로 AdMob 실광고 테스트 | 사용자 | ❌ 미시작 | 내부 테스트 트랙 활용 |
| 0.4 | assetlinks.json SHA-256 값 교체 | 사용자 | ❌ 미시작 | Play Console → 앱 무결성 |
| 0.5 | Play Console 콘텐츠 등급(IARC) 설정 | 사용자 | ❌ 미시작 | 설문지 작성 |
| 0.6 | Play Console 데이터 안전 섹션 작성 | 사용자 | ❌ 미시작 | 수집 데이터 선언 |
