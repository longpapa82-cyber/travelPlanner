...
export class InitialSchema1770818839499 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."users_provider_enum" AS ENUM('email', 'google', 'apple', 'kakao')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."trips_status_enum" AS ENUM('upcoming', 'ongoing', 'completed')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_12c3dec602b669b92427f54112" ON "affiliate_clicks" ("provider") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_aa2e63a7d1aa27a83a8c1612c6" ON "affiliate_clicks" ("trackingId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_b0a6b825908a9952432125e310" ON "affiliate_clicks" ("converted") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_911a70423d5689cd446c3fbcac" ON "affiliate_clicks" ("userId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_61db8e24b4ab5b5c1670574d83" ON "affiliate_clicks" ("tripId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_f6e153e4c8e1fa8129c9e22dd6" ON "affiliate_clicks" ("tripId", "createdAt") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_e6bf46f48513cc156399ba6175" ON "affiliate_clicks" ("userId", "createdAt") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_ee52474a6b6188fbe799632f95" ON "affiliate_clicks" ("provider", "createdAt") `,
    );
    await queryRunner.query(
      `ALTER TABLE "itineraries" ADD CONSTRAINT "FK_e40adba4542a6f942ef01405c53" FOREIGN KEY ("tripId") REFERENCES "trips"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "trips" ADD CONSTRAINT "FK_db768456df45322f8a749534322" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "affiliate_clicks" ADD CONSTRAINT "FK_911a70423d5689cd446c3fbcac3" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "affiliate_clicks" ADD CONSTRAINT "FK_61db8e24b4ab5b5c1670574d838" FOREIGN KEY ("tripId") REFERENCES "trips"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "affiliate_clicks" DROP CONSTRAINT "FK_61db8e24b4ab5b5c1670574d838"`,
    );
    await queryRunner.query(
      `ALTER TABLE "affiliate_clicks" DROP CONSTRAINT "FK_911a70423d5689cd446c3fbcac3"`,
    );
    await queryRunner.query(
      `ALTER TABLE "trips" DROP CONSTRAINT "FK_db768456df45322f8a749534322"`,
    );
    await queryRunner.query(
      `ALTER TABLE "itineraries" DROP CONSTRAINT "FK_e40adba4542a6f942ef01405c53"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_ee52474a6b6188fbe799632f95"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_e6bf46f48513cc156399ba6175"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_f6e153e4c8e1fa8129c9e22dd6"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_61db8e24b4ab5b5c1670574d83"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_911a70423d5689cd446c3fbcac"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_b0a6b825908a9952432125e310"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_aa2e63a7d1aa27a83a8c1612c6"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_12c3dec602b669b92427f54112"`,
    );
