...
const translations: Record<string, Record<SupportedLang, string>> = {
  ...
  'auth.invalid.email.domain': {
    ko: '이메일 주소를 받을 수 없는 도메인입니다. 주소를 다시 확인해주세요.',
    en: "This email domain can't receive mail. Please check the address.",
    ja: 'このメールドメインはメールを受信できません。アドレスをご確認ください。',
    zh: '该邮箱域名无法接收邮件。请检查地址。',
    es: 'Este dominio de correo no puede recibir mensajes. Verifica la dirección.',
    de: 'Diese E-Mail-Domain kann keine E-Mails empfangen. Bitte überprüfen Sie die Adresse.',
    fr: "Ce domaine de messagerie ne peut pas recevoir d'e-mails. Veuillez vérifier l'adresse.",
    th: 'โดเมนอีเมลนี้ไม่สามารถรับอีเมลได้ โปรดตรวจสอบที่อยู่',
    vi: 'Tên miền email này không thể nhận thư. Vui lòng kiểm tra lại địa chỉ.',
    pt: 'Este domínio de e-mail não pode receber mensagens. Verifique o endereço.',
    ar: 'لا يمكن لنطاق البريد الإلكتروني هذا استقبال الرسائل. يرجى التحقق من العنوان.',
    id: 'Domain email ini tidak dapat menerima email. Silakan periksa alamatnya.',
    hi: 'यह ईमेल डोमेन मेल प्राप्त नहीं कर सकता। कृपया पता जांचें।',
    it: 'Questo dominio email non può ricevere messaggi. Controlla l’indirizzo.',
    ru: 'Этот почтовый домен не может принимать письма. Проверьте адрес.',
    tr: 'Bu e-posta alan adı posta alamıyor. Lütfen adresi kontrol edin.',
    ms: 'Domain e-mel ini tidak dapat menerima e-mel. Sila semak alamat tersebut.',
  },
